...
export const PLUGIN_META: Record<string, PluginMetadata> = {
    ...
    'o11n-plugin-infoblox': { image: `${import.meta.env.BASE_URL}icons/infoblox.png`, color: 'emerald', tags: ['3RD PARTY'], downloadUrl: 'https://docs.infoblox.com/space/ipamvmware8x/52048987/Introduction' },
