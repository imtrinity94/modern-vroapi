...
export const PLUGIN_META: Record<string, PluginMetadata> = {
    'o11n-core': { image: `${import.meta.env.BASE_URL}icons/vro.png`, color: 'indigo', tags: ['IN-BUILT', 'CERTIFIED'], version: '8.18.1.24266232' }, // Assuming core matches build version like Configurator/Support/vCO
    ...
    'o11n-plugin-f5': { image: `${import.meta.env.BASE_URL}icons/f5.png`, color: 'red', tags: ['3RD PARTY', 'CERTIFIED'], version: '4.1.0.2' },
    ...
    'o11n-plugin-lenovo': { image: `${import.meta.env.BASE_URL}icons/lenovo.png`, color: 'red', tags: ['3RD PARTY', 'CERTIFIED'], version: '1.2.0.1' },
    ...
    'o11n-plugin-srm': { image: `${import.meta.env.BASE_URL}icons/srm.png`, color: 'blue', tags: ['CERTIFIED'], version: '9.0.4.0.24920184' },
    ...
    'o11n-plugin-vco': { image: `${import.meta.env.BASE_URL}icons/vro.png`, color: 'slate', tags: ['IN-BUILT', 'CERTIFIED'], version: '8.18.1.24266232' },
    'o11n-plugin-vr': { image: `${import.meta.env.BASE_URL}icons/vr.png`, color: 'blue', tags: ['CERTIFIED'], version: '9.0.4.0.24920185' },
    'o11n-plugin-vra': { image: `${import.meta.env.BASE_URL}icons/vra.png`, color: 'cyan', tags: ['IN-BUILT', 'CERTIFIED'], version: '8.14.0.23221431' },
    'o11n-plugin-vsan': { image: `${import.meta.env.BASE_URL}icons/vSAN.png`, color: 'blue', tags: ['CERTIFIED'], version: '2.2.0.23824262' },
