...
export const PLUGIN_META: Record<string, PluginMetadata> = {
    ...
    'o11n-plugin-srm': { image: `${import.meta.env.BASE_URL}icons/srm.png`, color: 'blue', tags: ['OFFICIAL'], downloadUrl: 'https://vcf.broadcom.com/vsc/services/details/vmware-cloud-foundation-orchestrator-plug-in-for-vmware-live-site-recovery-2?slug=true', version: '9.0.4.0.24920184' },
    ...
    'o11n-plugin-vcfautomation': { image: `${import.meta.env.BASE_URL}icons/vcfa-all-apps.png`, color: 'violet', tags: ['IN-BUILT', '9.x ONLY'] },
    ...
    'o11n-plugin-vum': { image: `${import.meta.env.BASE_URL}icons/update-manager.png`, color: 'amber', tags: ['IN-BUILT'], version: '8.1.1.24105053' },
